...
wget https://dlcdn.apache.org/tomcat/tomcat-9/v9.0.99/bin/apache-tomcat-9.0.98.tar.gz
...
sed -i '58  a\<user username="tomcat" password="raham123" roles="manager-gui, manager-script"/>' apache-tomcat-9.0.99/conf/tomcat-users.xml
...
sed -i '22d'  apache-tomcat-9.0.99/webapps/manager/META-INF/context.xml
